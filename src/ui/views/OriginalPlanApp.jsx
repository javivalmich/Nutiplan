...
import { GOAL_ADJ, computeTrend, getNutricionistaFeedback, adherenciaPct, calcTDEE,
         calcTarget, calcMacros, computeStrategy, getMealRules, computeCheckinAdjustment,
         getPastProteinFrequency, searchFoods, calcFoodKcal, getDefaultAlts, buildPlan }
  from "../../engine/index.js";
import { SDB } from "../../data/sdb.js";
import { __PERF, __TRACE, getWeekNumber } from "../../data/runtime.js";
import { trackUserAction, traceSetPlan, _checkPostActionOverwrite } from "../../data/echoGuard";
import { PDB, loadData, saveData, clearData, loadMealMemory, saveMealMemory, loadProgress,
         addWeekProgress, _isObj, _validateProfile } from "../../data/db.js";
import { InvitationStore } from "../../data/invitations.js";
import { THEME, STRATEGIES, COPY, ACTIVITIES, GOALS, INTOLERANCES, DAYS_SHORT, GOAL_LABELS,
         GOAL_COLORS, NUTIPLAN_LOGO, SANS_EMOJI, SERIF_EMOJI, AD_SLOTS } from "../constants";
import { AdminPanel } from "./AdminPanel.jsx";
import { Stepper } from "../common/Stepper";
import { DOBPicker } from "../common/DOBPicker";
import { NutiMessage } from "../common/NutiMessage";
...
export function OriginalPlanApp({ currentUser, activePlanMeta, onLogout, onPlanUpdated }) {
